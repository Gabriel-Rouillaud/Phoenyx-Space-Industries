...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToOne(targetEntity=Ticket::class, mappedBy="user", cascade={"persist", "remove"})
     */
    private $ticket;
    ...
    public function setTicket(?Ticket $ticket): self
    {
        ...
        $newUser = null === $ticket ? null : $this;
        if ($ticket->getUser() !== $newUser) {
    ...
    public function setCard(?Card $card): self
    {
        ...
        // set (or unset) the owning side of the relation if necessary
        $newUser = null === $card ? null : $this;
        if ($card->getUser() !== $newUser) {
